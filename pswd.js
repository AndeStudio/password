...
function copy(obj){//复制 
	...
	document.getElementById(obj.id).setAttribute("data-clipboard-target","#target2");//data-clipboard-target，复制可见
}
...
gen将生成一个随机密码，显示在文本输入框，且追加到文本输入域中。
genCopy与gen基本一样，但将同时复制文本框的内容。
copy将复制文本域的内容。
save尚待开发...`//占位符
